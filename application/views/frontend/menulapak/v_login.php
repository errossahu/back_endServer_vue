...
<html lang="en">
    <head>
        ...
        <link href="<?=base_url()?>assets/menulapak/dist/css/styles.css" rel="stylesheet" />
    ...
    <body class="bg-primary">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <?php echo form_open('menulapak/login/login');?>
                                        <form method="post">
        ...
        <script src="<?=base_url()?>assets/menulapak/js/scripts.js"></script>
    </body>
</html>
