...
<div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <?php echo form_open('backend/cuci/editCuci/'.$cuci->id_cuci) ?>
              <form method="post" role="form"  onSubmit="return validasi()">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Tempat</label>
                    <input value="<?=$cuci->nama_cuci?>" placeholder="Nama Tempat" name="nama_cuci" type="text" class="form-control" id="namaPegawai" >
                  </div>  
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="" name="gambar" placeholder="gambar">
                    <div>
